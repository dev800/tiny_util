defmodule TinyUtil.Mbcs do
  @moduledoc """
  ## Usage

      # Start mbcs server
      iex> TinyUtil.Mbcs.start
      :ok

      # Convert UTF-8 to Shift_JIS
      iex> TinyUtil.Mbcs.encode!("九条カレン", :cp932)
      <<139, 227, 143, 240, 131, 74, 131, 140, 131, 147>>

      # Convert Shift_JIS to UTF-8, and return as a list
      iex> TinyUtil.Mbcs.decode!([139, 227, 143, 240, 131, 74, 131, 140, 131, 147], :cp932, return: :list)
